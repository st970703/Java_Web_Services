...
public class ConcertResourceIT {
    ...
    private static String WEB_SERVICE_URI = "http://localhost:10002/services/concerts";
    ...
    @Test
    public void testRetrieveWithRange_Xml() {
        Response response = null;
